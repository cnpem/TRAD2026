...
Material de leitura com os conceitos trabalhados durante o treinamento. Para a parte prática (instalação, exercícios e comandos passo a passo), use o [*Roteiro Teórico-Prático*](#containers-module/roteiro-de-aula-pratica.md) que acompanha este material.
